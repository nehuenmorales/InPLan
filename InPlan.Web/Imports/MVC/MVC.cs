...
public static class Views
{
    public static class Administration
    {
        ...
        {
            public const string DemoRedirectPage = "~/Modules/Administration/OpenId/DemoRedirectPage.cshtml";
        }
    ...
    public static class Membership
    {
        public static class Account
        {
            public static class Login
            {
                ...
                public const string _MigrationWarning = "~/Modules/Membership/Account/Login/_MigrationWarning.cshtml";
