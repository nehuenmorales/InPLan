    ...
    public static partial class Texts
    {
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static readonly LocalText EmailSubject = "Reset Your InPlan Password";
                ...
                {
                    public static readonly LocalText ActivateEmailSubject = "Activate Your InPlan Account";
            ...
            public static readonly LocalText SiteTitle = "InPlan";
        }
